...
import { API_URL } from '../utils/config'; // Make sure this import is correct

const Login = () => {
  // FIX: Only ONE state for form data is needed
  ...
  return (
    <div className="flex h-screen w-full bg-slate-900 relative overflow-hidden items-center justify-center">
      ...
      >
        ...
        {error && (
          <motion.div initial={{ x: -10, opacity: 0 }} animate={{ x: 0, opacity: 1 }} className="bg-red-500/20 border border-red-500/50 text-red-200 p-3 rounded-lg mb-6 text-sm text-center">
            {error}
          </motion.div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="group">
            <label className="block text-xs font-medium text-blue-300 mb-1 uppercase tracking-wider">Email</label>
          ...
          <div className="group">
            <label className="block text-xs font-medium text-blue-300 mb-1 uppercase tracking-wider">Password</label>
            <div className="relative">
